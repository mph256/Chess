...
public class PromotionBoardBuilder extends BoardBuilder {
	...
	public void addWhiteRooks() {
		...
		try {
			...
			board.addPiece(1, 7, PieceFactory.getInstance().createPiece("white", "rook"));
	...
	public void addWhitePawns() {
		...
		try {
			...
			board.addPiece(1, 0, PieceFactory.getInstance().createPiece("white", "pawn"));
